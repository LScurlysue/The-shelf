    ...
    (async () => {
      try {
        ...
        if (result && result.value) {
          ...
          setBooks(finalBooks);
          await window.storage.set('books', JSON.stringify(finalBooks), false);
        } else {
          setBooks(SEED_BOOKS);
